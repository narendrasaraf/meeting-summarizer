...
from app.models.db import Meeting, engine
...
def process_meeting_task(meeting_id: int, file_path: str) -> None:
    """RQ task: transcribe then summarize, updating the DB row."""
    ...
    if settings.SIMULATE_MODE:
        ...
        with _Session(engine) as session:
            ...
            meeting.key_decisions_json = json.dumps(
